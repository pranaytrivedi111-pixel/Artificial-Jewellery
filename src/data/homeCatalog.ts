...
export const GENUINE_PRODUCTS: GenuineProduct[] = [
  ...
  },
  {
    ...
    subtitle: '18K Gold Plated • Chic Korean Dainty Purse Motif • Hypoallergenic & Ultra-Lightweight Everyday Luxury',
    category: 'Earrings & Jhumkas',
    badge: 'ROYAL VIRAL TRENDING',
    price: 399,
    originalPrice: 999,
    discountPercent: 60,
    rating: 4.9,
    ...
    image: '/e1.webp',
    hoverImage: '/e2.webp',
    tag: 'Korean Dainty Earrings',
    inStockCount: 19,
    highlights: [
      '18K Yellow Gold Plating with Glossy Milk-White Enamel Inlay',
      'Chic U-Shaped Miniature Handbag Silhouette with Sculpted Handle',
      'Ultra-Lightweight & Comfort-Fit (Zero Ear Lobe Pulling)',
      'Secure Hinged Click-Top Latch Back for Everyday Wear',
    ],
    occasion: 'Daily Wear, College, Office, Casual Western, Brunch & Gifting',
    packageContains: '1 Pair of White Enamel Handbag Drop Earrings + Royal Velvet Gift Pouch',
  },
  {
...
export const HOME_CATEGORIES = [
  ...
  {
    id: 'handbag-earrings',
    label: 'Handbag Drop Earrings',
    icon: '👜',
    image: '/e1.webp',
    count: 1,
    targetProduct: 'white-enamel-handbag-earrings' as ProductId,
  },
  {
    id: 'emerald-snake',
